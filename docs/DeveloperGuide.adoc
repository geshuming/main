...
Users can mark modules as pass:[<text style="color:darkgreen">completed</text>], pass:[<text style="color:darkorange">ongoing</text>] or pass:[<text style="color:blue">planned</text>]. Users can also timestamp the modules with the semester that the user pass:[<text style="color:darkgreen">has taken</text>]/pass:[<text style="color:darkorange">is taking</text>]/pass:[<text style="color:blue">will take</text>] the module.
...
* pass:[<text style="color:darkgreen">completed</text>],
* pass:[<text style="color:darkorange">ongoing</text>] and
* pass:[<text style="color:blue">planned</text>].
...
. pass:[<text style="color:darkgreen">Completed modules</text>] will be hidden from the module list, but still viewable through a `listall` command (proposed command) and accessible through the `view` command.

. pass:[<text style="color:darkgreen">Completed modules</text>] and pass:[<text style="color:darkorange">ongoing modules</text>] can be used to determine if a user fulfil the requirements for their pass:[<text style="color:blue">planned modules</text>].
